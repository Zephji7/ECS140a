...
public class Scanner {
	...
	public static void main(String[] args) throws FileNotFoundException {
		// C keywords
		List<String> kylist = Arrays.asList("auto","break","case","char","const","continue","default","do","double","else","enum","extern","float",
				"for","goto","if","int","long","register","return","short","signed","sizeof","static","struct","switch","typedef","union","unsigned",
				"void","volatile","while");
